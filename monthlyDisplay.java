 ...
 * 
 */
class monthlyDisplay extends JFrame implements ActionListener
{
    ...
    public monthlyDisplay(JFrame pFrame)
    {
        gFrame = pFrame;
        ...
        nameLabel = new JLabel("Monthly Bills");
        ...
        Object[][] data = Obj1.getdata("monthlyBillsTable", columns);
